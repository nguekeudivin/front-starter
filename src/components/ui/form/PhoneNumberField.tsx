    ...
    return (
        <div>
            <div
                ...
                className={clsx(cn('relative flex h-12 items-center rounded-md border border-gray-300', className), {
            ...
            >
                ...
                <input
                    ...
                    className={cn('w-full border-none px-3 py-2 focus:border-none focus:outline-none', inputClassName)}
                />

                {value != undefined && value != '' && (
                    <button onClick={() => onValueChange('')} className="absolute top-[25%] right-2 rounded-full p-1 hover:bg-gray-200">
