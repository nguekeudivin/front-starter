...
export const Alert: FC<AlertProps> = ({ message, name, className, autoClose }) => {
    ...
    if (display.visible[name]) {
        return (
            <motion.div
                ...
                id="alert-border-1"
                className={cn('mb-4 flex border-t-4 border-blue-300 bg-blue-50 p-4 text-blue-800', className)}
                role="alert"
            >
                <Info />
