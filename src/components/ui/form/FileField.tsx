...
export function FileField({ file, onFileChange, id, error, className, name, placeholder }: FileFieldProps) {
        ...
        <div>
            ...
            >
                {file == undefined ? (
                    <>
                        {placeholder ? (
                            ...
                            <>
                                ...
                                <span className="mt-2 text-sm font-medium">Drop or select file</span>
                    ...
                    <label htmlFor={id} className="h-full w-full text-sm hover:bg-gray-200/30">
